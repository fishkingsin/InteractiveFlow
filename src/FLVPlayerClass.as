...
/*addEventListener(Event.ADDED_TO_STAGE,function onAddedToStage(E:Event)
		...
		public function startVid(path:String):void
		{
			...
			//trace("start playing video "+path);
		...
		{
			//trace("FLVPlayerClass: media started playing");
		}

		protected function doMediaFinished(evt:MediaEvent):void
		{
			trace("FLVPlayerClass: media finished playing");
			if (isLoop)
			{
				startVid(oldPath);
			}
		...
		{
			//trace("FLVPlayerClass: media error while playing");
		}
		protected function doMediaDuration(evt:MediaTimeEvent):void
		{
			//trace("FLVPlayerClass: media is " + evt.time + " seconds long");
		}
		protected function doMediaTime(evt:MediaTimeEvent):void
		{
			//trace("FLVPlayerClass: media is at " + evt.time + " seconds");
		}
	}
}